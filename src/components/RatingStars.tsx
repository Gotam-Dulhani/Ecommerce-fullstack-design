    ...
    <div className="flex items-center gap-1.5">
      <div className="flex items-center gap-0.5">
        {Array.from({ length: full }).map((_, i) => (
          <svg key={`f-${i}`} viewBox="0 0 20 20" className={`${starClass} fill-amber-400`} aria-hidden="true">
            <path d="M10 15.27 16.18 19l-1.64-7.03L20 7.24l-7.19-.61L10 0 7.19 6.63 0 7.24l5.46 4.73L3.82 19z" />
          </svg>
        ))}
        {half === 1 && (
          <svg viewBox="0 0 20 20" className={`${starClass} fill-amber-400`} aria-hidden="true">
            <defs>
        ...
        {Array.from({ length: empty }).map((_, i) => (
          <svg key={`e-${i}`} viewBox="0 0 20 20" className={`${starClass} fill-gray-200`} aria-hidden="true">
            <path d="M10 15.27 16.18 19l-1.64-7.03L20 7.24l-7.19-.61L10 0 7.19 6.63 0 7.24l5.46 4.73L3.82 19z" />
          </svg>
        ))}
      </div>
